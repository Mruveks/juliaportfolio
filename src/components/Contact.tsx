...
const socialLinks = [
  {
    label: "Instagram", href: "https://instagram.com", handle: "@juliamartinez",
  ...
  {
    label: "TikTok", href: "https://tiktok.com", handle: "@juliamartinez",
  ...
  {
    label: "LinkedIn", href: "https://linkedin.com", handle: "Julia Martinez",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <div className="flex items-center gap-4 mb-12">
              ...
              <a href="mailto:hello@juliamartinez.co" className="text-[#1A1714] hover:text-[#B5926A] transition-colors duration-200 text-lg">
